...
commandToRun = taskNameInCommandLine + " --configuration json://" + updatedConfigFileName + " --severity error --shm-segment-size 12000000000" + " --aod-reader-json Configs/readerConfiguration_reducedEvent.json -b"
"""
